#!/bin/bash
# TTSR-lowlight v3 — Fine-tune from v2 best PSNR checkpoint (epoch 45)
# 核心改动: LR decay + 更高 perceptual/exposure loss + 更长训练
# 从 v2 epoch 45 续训，跳过 init warmup
...
/root/miniconda3/envs/ttsr/bin/python main.py \
    ...
    --save_dir /root/data/experiments/TTSR-lowlight-v3 \
    --reset True \
    --enhance_mode True \
